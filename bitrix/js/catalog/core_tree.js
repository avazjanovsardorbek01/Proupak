(function(window) {
            ...
            if (!!this.parentContainer) {
                if (this.type === 'string' || this.type === 'prefix') {
                    this.parentContainer.appendChild(BX.create(
                        'SPAN', {
                            props: {
                                className: (this.type === 'prefix' ? 'control-prefix' : 'control-string')
                            },
    ...
    BX.TreeCondCtrlInput.prototype.InitValue = function() {
        if (BX.TreeCondCtrlInput.superclass.InitValue.apply(this, arguments)) {
            BX.adjust(this.link, {
                html: BX.util.htmlspecialchars(this.valuesContainer[this.id])
            });
    ...
    BX.TreeCondCtrlBaseSelect.prototype.setValueText = function() {
        ...
        BX.adjust(this.link, {
            html: BX.util.htmlspecialchars(titles.join(', '))
        });
        titles = null;
    };
    ...
    BX.TreeCondCtrlBaseSelect.prototype.SetValue = function() {
        ...
        if (BX.TreeCondCtrlBaseSelect.superclass.SetValue.apply(this, arguments))
            BX.adjust(this.link, {
                html: BX.util.htmlspecialchars(arText.join(', '))
            });
        else
            BX.adjust(this.link, {
                html: this.defaultText
    ...
    BX.TreeUserCondCtrlPopup.prototype.DeleteItem = function(e) {
        ...
        var itemContainer = BX.findParent(srcElement, {
            className: 'condition-item',
            tagName: 'span'
        }, 3);
        if (!itemContainer) {
        ...
        BX.remove(BX.findParent(srcElement, {
            className: 'condition-item',
            tagName: 'span'
        }, 3));
        BX.remove(BX.findChild(this.parentContainer, {
            tagName: 'input',
            attribute: {
                name: this.name + '[]',
                value: srcElement.getAttribute('bx-data-value')
            }
        }, 3));
    ...
    BX.TreeConditions.prototype.RenderTree = function() {
        if (this.boolResult) {
            ...
            if (!this.form) {
                ...
                this.parentContainer = BX(this.parentContainer);
                if (!!this.parentContainer) {
                    BX.adjust(this.parentContainer, {
                        style: {
                            position: 'relative',
                            zIndex: 1
                        }
    ...
    BX.TreeConditions.prototype.RenderCreateOneActionBtn = function(obTreeLevel, CurControl) {
        if (this.RenderCreateBtn(obTreeLevel, CurControl)) {
            ...
            BX.adjust(obTreeLevel.addBtn, {
                attrs: {
                    'bx-data-create-one-action-btn': true
                }
            });
            ...
            if (!!obTreeLevel.logic && typeof(obTreeLevel.logic) === 'object') {
                ...
                logic = BX.create(
                    'DIV', {
                        ...
                        style: {
                            zIndex: parseInt(BX.style(obTreeLevel.wrapper, 'z-index'), 10) + 1
                        },
