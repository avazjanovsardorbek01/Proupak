...
(function() {
    ...
    (function(exports) {
        ...
        function _classPrivateMethodInitSpec$1(obj, privateSet) {
            _checkPrivateRedeclaration$2(obj, privateSet);
            privateSet.add(obj);
        }
    ...
    (function(window) {
        ...
        */
        ...
        BX.userOptions.__get_values = function({
