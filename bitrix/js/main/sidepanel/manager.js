(function() {
    ...
    BX.SidePanel.Manager.prototype = {
        ...
        isOnTop: function() {
            ...
            return BX.hasClass(element, "side-panel") || BX.findParent(element, {
    ...
    class Toolbar extends BX.Event.EventEmitter {
        ...
        createItem(itemOptions) {
            ...
            if (!BX.Type.isStringFilled(options.entityType) ||
            ...
            const menu = BX.Main.MenuManager.create({
                ...
                events: {
                    onShow: (event) => {
                        ...
                        popup.setOffset({
                            offsetLeft: offsetLeft + BX.Main.Popup.getOption('angleLeftOffset')
                        });
                    },
                },
            });
