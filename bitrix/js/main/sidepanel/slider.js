...
(function() {
    ...
    BX.SidePanel.Slider.prototype = {
        ...
        setFrameSrc: function() {
            ...
            var url = BX.util.add_url_param(this.getUrl(), {
                IFRAME: "Y",
            ...
            return BX.create("div", {
                ...
                children: [
                    BX.create("div", {
                        ...
                        html: '<svg class="side-panel-default-loader-circular" viewBox="25 25 50 50">' +
                            '<circle ' +
            ...
            if (loader === "crm-entity-details-loader") {
                return BX.create("div", {
                    ...
                    children: [
                        BX.create("img", {
                            attrs: {
                                src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAMAAABhq6zVAAAAA1BMVEX" +
                        ...
                        BX.create("div", {
                            ...
                            children: [
                                BX.create("img", {
                                    attrs: {
                                        src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAMAAABhq6zVAAAAA1B" +
                        ...
                        BX.create("div", {
                            ...
                            children: [
                                BX.create("img", {
                                    attrs: {
                                        src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAMAAABhq6zVAAAAA1BM" +
                ...
                return BX.create("div", {
                    ...
                    children: [
                        ...
                        BX.create("img", {
                            attrs: {
                                src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAMAAABhq6zVAAAAA" +
        ...
        handleCrossOriginWindowMessage: function(event) {
            ...
            if (message.type === 'BX:SidePanel:close') {
                ...
                let pageEvent = new BX.SidePanel.MessageEvent({
                    sender: this,
                    data: message.data
                });
        ...
        handleFrameKeyDown: function(event) {
            ...
            var popups = BX.findChildren(this.getWindow().document.body, {
