...
(function() {
    ...
    class PullClient {
        ...
        subscribeUserStatusChange(userId, callback) {
            ...
            return new Promise((resolve, reject) => {
                this.jsonRpcAdapter.executeOutgoingRpcCommand(RpcMethod.SubscribeStatusChange, {
                    userId
                }).then(() => {
        ...
        unsubscribeUserStatusChange(userId, callback) {
            ...
            if (this.userStatusCallbacks[userId]) {
                ...
                if (this.userStatusCallbacks[userId].length === 0) {
                    return this.jsonRpcAdapter.executeOutgoingRpcCommand(RpcMethod.UnsubscribeStatusChange, {
                        userId
                    });
                }
            }
